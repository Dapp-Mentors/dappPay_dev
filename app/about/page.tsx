        ...
        <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-black relative overflow-hidden">
            ...
            <section className="relative z-10 pt-32 pb-20 px-6">
                <div className="max-w-7xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#DC1FFF]/10 to-[#00FFA3]/10 border border-[#DC1FFF]/20 rounded-full mb-6 backdrop-blur-sm hover:border-[#00FFA3]/40 transition-all duration-300 group cursor-pointer animate-fade-in">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div className="animate-slide-left">
                            ...
                            <div className="space-y-4">
                                <div className="group flex items-center gap-3 p-4 bg-slate-800/30 rounded-lg border border-slate-700/30 hover:border-[#00FFA3]/50 transition-all duration-300 backdrop-blur-sm">
                                    <div className="w-10 h-10 bg-gradient-to-br from-[#00FFA3]/20 to-[#00FFA3]/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div className="group flex items-center gap-3 p-4 bg-slate-800/30 rounded-lg border border-slate-700/30 hover:border-[#DC1FFF]/50 transition-all duration-300 backdrop-blur-sm">
                                    <div className="w-10 h-10 bg-gradient-to-br from-[#DC1FFF]/20 to-[#DC1FFF]/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                ...
                                <div className="group flex items-center gap-3 p-4 bg-slate-800/30 rounded-lg border border-slate-700/30 hover:border-[#03E1FF]/50 transition-all duration-300 backdrop-blur-sm">
                                    <div className="w-10 h-10 bg-gradient-to-br from-[#03E1FF]/20 to-[#03E1FF]/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div className="relative animate-slide-right">
                            <div className="relative group">
                                <div className="absolute -inset-1 bg-gradient-to-r from-[#DC1FFF] to-[#00FFA3] rounded-2xl blur opacity-25 group-hover:opacity-75 transition duration-500" />
                                <div className="relative bg-gradient-to-br from-[#DC1FFF] to-[#00FFA3] rounded-2xl p-8 text-black font-semibold text-center shadow-2xl">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="group p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-[#DC1FFF]/20 rounded-2xl backdrop-blur-sm hover:border-[#DC1FFF]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#DC1FFF]/20 relative overflow-hidden animate-slide-up" style={{ animationDelay: '0.1s' }}>
                            ...
                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#DC1FFF] to-[#00FFA3] rounded-xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-[#DC1FFF]/50">
                        ...
                        <div className="group p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-[#03E1FF]/20 rounded-2xl backdrop-blur-sm hover:border-[#03E1FF]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#03E1FF]/20 relative overflow-hidden animate-slide-up" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#03E1FF] to-[#00FFA3] rounded-xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-[#03E1FF]/50">
                        ...
                        <div className="group p-8 bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-[#00FFA3]/20 rounded-2xl backdrop-blur-sm hover:border-[#00FFA3]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#00FFA3]/20 relative overflow-hidden animate-slide-up" style={{ animationDelay: '0.3s' }}>
                            ...
                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-gradient-to-br from-[#00FFA3] to-[#03E1FF] rounded-xl flex items-center justify-center mb-6 group-hover:rotate-12 group-hover:scale-110 transition-all duration-300 shadow-lg shadow-[#00FFA3]/50">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className="group text-center p-6 bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-[#DC1FFF]/20 rounded-2xl backdrop-blur-sm hover:border-[#DC1FFF]/60 transition-all duration-500 hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-[#DC1FFF]/20 animate-slide-up" style={{ animationDelay: member.delay }}>
                                <div className="relative inline-block mb-4">
                                    <div className={`w-20 h-20 bg-gradient-to-br ${member.color} rounded-full mx-auto flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                                        <member.icon className="w-10 h-10 text-black" />
                                    </div>
                                    <div className="absolute inset-0 w-20 h-20 mx-auto bg-gradient-to-br ${member.color} rounded-full blur-md opacity-0 group-hover:opacity-60 transition-opacity duration-300" />
                                </div>
